		...
		<ul class="categories_list second_font w_break">
        		<li class="clearfix m_bottom_14">											
					<div class="styled_select relative">
						<div class="select_title fs_medium fw_light color_light relative d_none tr_all categoria_valor">@if($cat != ''){{$cat}}@else{{'Seleccionar Categoria'}}@endif</div>
                ...
                <li class="clearfix m_bottom_14">											
					<div class="styled_select relative">
						...
						<select data-orderby="0">
							<option value="Crochet">Crohet</option>
                ...
                <button class="button_type_2 d_block w_full t_align_c grey state_2 tr_all second_font fs_medium tt_uppercase filtro_hilados_button" data-url="{{URL::to('/accesorios')}}"><i class="fa fa-search d_inline_m m_right_9 fs_"></i>Ver Resultados</button>
				</li>
        </ul>
	</section>	
   <!-- 
