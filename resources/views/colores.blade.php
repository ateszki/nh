...
<!-- breadcrumbs -->
			<div class="breadcrumbs bg_grey_light_2 fs_medium fw_light">
				<div class="breadcrumbs bg_grey_light_2 fs_medium fw_light">
				<div class="container">
					<a href="{{URL::to('/')}}" class="sc_hover">Home</a> / <a href="{{URL::to('/hilados')}}?temporada={{$temporada}}&tipo={{$tipo}}" class="sc_hover">Hilados / {{ trim($temporada)}} @if($tipo!='') / {{ trim($tipo)}} @endif</a> / <span class="color_ligth">{{preg_replace('/\*[a-zA-Z0-9 ]*/','',$hilado->descripcion)}}</span>
				</div>
			</div>
			</div>
