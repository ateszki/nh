										...
										<figcaption class="bg_white relative p_bottom_15">
											<div class="row">
												...
												<div class="col-lg-12 col-md-12 color_light fs_large second_font t_align_r t_sm_align_c m_bottom_9">
													<span class="scheme_color d_block">${{$color["precio"]*3}} x paq.</span>
												</div>
											</div>
