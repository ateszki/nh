							...
							<div id="can_change_layout" class="category_isotope_container five_columns wrapper m_bottom_10 m_xs_bottom_0" data-isotope-options='{
								...
								<div class="category_isotope_item">
									<figure class="product_item type_2 c_image_container relative frame_container bg_white t_sm_align_c r_image_container qv_container" >
										...
										<div class="relative">
											<div class="d_block">
												<a href="{{URL::to('hilados/wide/'.$hilado->codigo)}}"><img src="{{URL::to('prodimag/'.$hilado->imagen.'-G.jpg')}}" alt="" class="c_image_1 tr_all" border="0"></a>
											</div>
										...
										<figcaption class="bg_white relative p_bottom_15">
											...
											<a href="{{URL::to('hilados/wide/'.$hilado->codigo)}}" class="button_type_2 m_bottom_9 d_block w_full t_align_c lbrown state_2 tr_all second_font fs_small tt_uppercase m_top_10"><i class="fa fa-eye d_inline_m m_right_9"></i>Ver Producto</a>
										</figcaption>
									</figure>
								</div>
                                @endforeach
